...
export function RealTimeAge({ birthDate }: RealTimeAgeProps) {
  const calculateAge = (currentDate: Date) => {
    ...
    return `${formattedYears} years, ${formattedDays} days, ${formattedHours} hours, ${formattedMinutes} minutes, ${formattedSeconds} seconds, ${formattedMilliseconds} milliseconds`;
  };
  ...
  useEffect(() => {
    ...
    // Update every 50ms for smooth real-time updates
