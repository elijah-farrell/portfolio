...
export const HoverEffect = ({
  ...
  return (
    <div
      className={cn(
        "relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 py-10",
        className
      )}
    >
      {items.map((item, idx) => (
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/[0.2] relative z-20",
        className
      )}
    >
