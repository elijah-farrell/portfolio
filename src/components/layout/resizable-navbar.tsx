  ...
  return (
    <div
      className={cn(
        ...
        !visible && !isMenuOpen && "bg-white dark:bg-[#0a0a0a]",
        visible && !isMenuOpen && "!backdrop-blur-[10px] !shadow-[0_0_24px_rgba(34,42,53,0.06),0_1px_1px_rgba(0,0,0,0.05),0_0_0_1px_rgba(34,42,53,0.04),0_0_4px_rgba(34,42,53,0.08),0_16px_68px_rgba(47,48,55,0.05),0_1px_0_rgba(255,255,255,0.1)_inset] !bg-white/80 dark:!bg-[#0a0a0a]/80 dark:!shadow-[0_0_24px_rgba(0,0,0,0.3),0_1px_1px_rgba(0,0,0,0.2),0_0_0_1px_rgba(255,255,255,0.05),0_0_4px_rgba(0,0,0,0.4),0_16px_68px_rgba(0,0,0,0.25),0_1px_0_rgba(255,255,255,0.1)_inset]",
