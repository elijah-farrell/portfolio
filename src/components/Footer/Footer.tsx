      ...
      <div className="max-w-6xl mx-auto">
        ...
        <FadeInOnScroll direction="up" duration={800} delay={200} elementId="footer-main">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="flex flex-col lg:col-span-1 text-center md:text-left">
              <h4 className="text-lg font-semibold mb-6">Connect</h4>
              <div className="flex flex-row gap-4 items-start justify-center md:justify-start">
                <a 
                  href="https://github.com/elijah-farrell" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center justify-center w-10 h-10 bg-white dark:bg-neutral-800 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 transition-all duration-200 group"
                >
            ...
            <div className="lg:col-span-1 text-center md:text-left">
              ...
              <div className="flex flex-row gap-6 justify-center md:justify-start">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-200 font-medium flex items-center gap-2"
                >
